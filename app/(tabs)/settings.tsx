...
export default function SettingsScreen() {
  ...
  const openSheets = async () => {
    await Linking.openURL("https://docs.google.com/spreadsheets/create");
  };
